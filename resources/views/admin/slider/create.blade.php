...
<div class="card mb-4">
    <h4 class="card-header">Add sliders</h4>
    <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="name" value="{{ old('title') }}" placeholder="Enter user name">
